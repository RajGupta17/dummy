...
// int dry_run[NO_OF_NODES] = {1,4,4,1}; // To be filled during dry run
...
// {
//     printf("Inside path follow task");
...
//         if (left == 1 || right == 1)
//         {
//             if ((final_run[final_traversal] - final_run[final_traversal - 1] == -1) || (final_run[final_traversal] - final_run[final_traversal - 1] == 3)) // for left
//             {
//                 left_turn();
//                 final_traversal++;
//             }
...
int pindex = 1;
#define NO_OF_NODES 100
int dry_run[NO_OF_NODES] = {1, 4, 3, 1, 4, 3, 1, 4, 1, 1, 2, 2}; // To be filled during dry run
int final_run[NO_OF_NODES] = {0};                                // after removing redundant values from dry run
int final_traversal = 1;
